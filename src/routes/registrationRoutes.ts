...
import { register, getRegistrations, getStudentRegistrations, cancelRegistration, deleteRegistration, updateStatus, getAll, updateRegistration, getCollegePrograms } from '../controllers/registrationController';
